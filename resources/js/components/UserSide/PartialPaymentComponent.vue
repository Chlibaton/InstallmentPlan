...
<div>
              <v-form ref="form" lazy-validation  @submit.prevent class="bg-light"> 
                   <v-card-title>
                    <span class="headline">Make Partial Payments</span>
                  </v-card-title>
                  <v-card-text>
                      ...
                      <v-layout wrap>
                         <v-flex xs12>
                          ...
                          <v-flex xs6>
                           ...
                           <v-flex xs12>
                            <v-text-field v-model="moneyRemUsed" label="Money Remittance Used (Western Union, Palawan, Cebuana, M lhuillier, LBC, 7-11, Bayad Center, Any Bank Etc..)" placeholder="Enter the money Remittance that you have used here" outlined ></v-text-field>
                         </v-flex>
                           <v-flex xs12>
  ...
  export default {
    data: () => ({
      ...
      paymentHeader:[
        ...
        { text: 'Partial Payments', value: 'partial_payment',  },
        { text: 'Balance', value: 'balance',  },
        ...
        .then((response)=>{
              ...
              this.customerDetails.user_id= response.data.id
                ...
                .then((response)=>{
                  ...
                  this.dateOrdered = response.data[0]['payment_date']
                  this.ProductName = response.data[0]['ordered_product']
                  this.DueDate = 'Three(3) Months Due Date: '+response.data[0]['due_date']
