    ...
    <div>
        ...
        <b-container class="vy-main-cont">
            <b-row class="t-row">
                ...
                <b-col md="4" class="t-row-2"><p>Easy Installment Plan</p></b-col>
            </b-row>
            <b-row class="m-row">
                <b-col md="7" class="t-row-2">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/8EFp46Bw6MA?autoplay=1&mute=1" allowfullscreen></iframe>
                    </div>
                </b-col>
